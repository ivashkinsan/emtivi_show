...
import styles from "./LogoCompact.module.css";
...
const LogoCompact = () => {
    ...
    return (
        <div className={styles.logo_container}>
            <canvas className={styles.canvas_ref_1} ref={canvasRef1} width="164" height="164" />
            <canvas className={styles.canvas_ref_2} ref={canvasRef2} width="213" height="164" />
            <canvas className={styles.canvas_ref_3} ref={canvasRef3}  width="164" height="164" />
            <canvas className={styles.canvas_ref_4} ref={canvasRef4}  width="82" height="164" />
            <canvas className={styles.canvas_ref_5} ref={canvasRef5}  width="200" height="164" />
            <canvas className={styles.canvas_ref_6} ref={canvasRef6} width="82" height="164" />
        </div>
    );
};
